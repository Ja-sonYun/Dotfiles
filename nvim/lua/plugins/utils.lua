return {
...

	{
		...
		init = function()
			...
			hl.set("RainbowDelimiterBlue", { ctermfg = 69 })
			hl.set("RainbowDelimiterGreen", { ctermfg = 106 })
			hl.set("RainbowDelimiterOrange", { ctermfg = 166 })
			hl.set("RainbowDelimiterCyan", { ctermfg = 147 })
